<%@ Page Language="VB" AutoEventWireup="false" CodeFile="changepass.aspx.vb" Inherits="_Default" %>
      ...
      <h4 ><strong>Remember</strong> ::Never share your password and do not respond to any mail which asks you for your Login-ID/Password. NIC does not request for such information by email.</h4><br/>
        ...
        <table class="auto-style1" style="margin-left:20%;">
            ...
            <tr style="margin-left:auto; margin-right:auto">
                <td class="auto-style3" style="text-align: right; font-weight: 700;">New-Password:&nbsp;&nbsp;&nbsp; </td>
                <td style="text-align: left" class="auto-style5">
                    &nbsp;&nbsp;
                    <asp:TextBox ID="TextBox1"  runat="server" style="opacity: 0.8; text-align: center;" TextMode="Password"></asp:TextBox>
            ...
            <tr>
                <td style="text-align: right; font-weight: 700; font-size: large" class="auto-style7">Confirm-Password:&nbsp;&nbsp;&nbsp; </td>
            ...
            <tr>
                <td style="text-align: center" colspan="2">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button Style="margin-left: 35%" ID="Button1" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#CCFFFF" Text="Update" BackColor="#0099FF" Height="40px" Width="92px" />
                &nbsp;
